...
"/Users/jbeazy/Documents/Work/Coding/Udemy Courses/Rust - AutoGPT Course/projects/web_template/src/code_template.rs";
...
"/Users/jbeazy/Documents/Work/Coding/Udemy Courses/Rust - AutoGPT Course/projects/web_template/src/main.rs";

const API_SCHEMA_PATH: &str =
"/Users/jbeazy/Documents/Work/Coding/Udemy Courses/Rust - AutoGPT Course/projects/auto_gippity/schemas/api_schema.json";
...
pub async fn ai_task_request(
    ...
    if llm_response_res.is_err() {
        println!(
            ...
            llm_response_res.unwrap_err()
        );
        println!("Trying second call to OpenAI...");
    ...
    if llm_response_res.is_err() {
        ...
        println!("Trying third call to OpenAI...");
        llm_response_res = call_gpt(vec![extended_msg.clone()]).await;
    }
    ...
    match llm_response_res {
        ...
        Err(e) => {
            println!("Third attempt failed with error: {:?}", e);
            panic!("Failed three times to call OpenAI")
        }
    }
}
